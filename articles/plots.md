...
**maptiles** is a interesting package that provides the ability of
downloading map tiles from different providers. It also has a specific
...
Giraud T (2025). *mapsf: Thematic Cartography*.
...
Details
    ...
    #>  maplegend      0.3.0     2025-06-30 [1] RSPM
    #>  mapsf        * 1.0.0     2025-07-01 [1] RSPM
    ...
    #>  rasterpic    * 0.3.0     2025-11-22 [1] local
