...
the **terra** package (`terra::plotRGB()`):
...
The **tidyterra** package provides full support for **terra** `SpatRaster`
objects:
...
also has a specific function for plotting **terra** `SpatRaster` objects:
