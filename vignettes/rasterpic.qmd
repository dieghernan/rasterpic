...
Getting started with **rasterpic** is easy: you need an image (`png`, `jpeg/jpg`
or `tif/tiff`) and a spatial object from the **sf** or **terra** package to
begin.
...
`rasterpic_img()` is an S3 generic, so other packages can provide methods for
