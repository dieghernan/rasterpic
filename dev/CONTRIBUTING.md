...
documentation directly in the **GitHub** web interface, as long as you
make the changes in the *source* file. This generally means editing
[**roxygen2**
...
- Fork the package and clone it onto your computer. If you have not done
  this before, use
  `usethis::create_from_github("dieghernan/rasterpic", fork = TRUE)`.
- Install all development dependencies with
  ...
  If `R CMD check` does not pass cleanly, ask for help before
  continuing.
...
- Make your changes, commit them to **Git**, then create a PR by running
  ...
  and following the prompts in your browser. The PR title should briefly
  describe the change. The PR body should contain `Fixes #issue-number`.
...
[Contributor Code of
Conduct](https://dieghernan.github.io/rasterpic/dev/CODE_OF_CONDUCT.md).
