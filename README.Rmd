...
| [di                                                                          |
| eghernan](https://github.com/dieghernan/rasterpic/commits?author=dieghernan) |
+------------------------------------------------------------------------------+

### Issues

+------------------------------------------------------------------------------+
| [![](https://avatars.githubuserco                                            |
| ntent.com/u/11481397?u=c7520bbc8ee90abe741324e8c6a2f2051932dea3&v=4){alt=""} |
| ](https://github.com/rhijmans)\                                              |
| [rhijmans](ht                                                                |
| tps://github.com/dieghernan/rasterpic/issues?q=is%3Aissue+author%3Arhijmans) |
+------------------------------------------------------------------------------+
